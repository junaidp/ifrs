...
import com.ifrs.client.view.CompanyWidget;
import com.ifrs.client.view.SectorWidget;
...
{   
	...
	private void bind() {
		...
		display.getTabWidget().getBtnSaveSector().addClickHandler(new ClickHandler() {
		...
		display.getTabWidget().getBtnAddSector().addClickHandler(new ClickHandler() {

			@Override
			public void onClick(ClickEvent event) {

				SectorWidget sectorwidget = new SectorWidget(false, "Enter Sector Name");
		...
		display.getTabWidget().getBtnAddCompany().addClickHandler(new ClickHandler() {

			@Override
			public void onClick(ClickEvent event) {


				CompanyWidget companywidget = new CompanyWidget(true, "Enter Company Name");
				for(int i=0; i< sectors.size(); i++){
					companywidget.getListBox().addItem(sectors.get(i).getSectorId()+"", sectors.get(i).getSectorName());
				}
		...
		display.getTabWidget().getBtnSaveCompany().addClickHandler(new ClickHandler() {
